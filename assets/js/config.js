...
function home_site_menus()
{
	...
	if(typeof pat_uid!='undefined' && pat_uid!=null && pat_uid!='0'){
		menu+='<div class="x_panel udocitbtn"><div class="x_content"> <a class="homepage" href="'+realsiteurl+'/apppatchat?pid='+pat_uid+'"><div class="animated flipInY col-lg-12 col-md-12 col-sm-2 col-xs-12"><h3><img src="assets/img/logo.png"/></h3></div></a></div></div>';
	}
	menu+='</div>';
	return menu;
}
